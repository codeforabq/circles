...
if (isset($HowManyAdults)){$adults=$HowManyAdults;}else{$adults="0";}
if (isset($HowManyChildren)){$children=$HowManyChildren; if ($children>3){$children="3";}}else{$children="0";}
if (isset($_POST['cl_adults_FT'])){$working="1";}else{$working="0";}
$county=$_POST['cl_county'];
$state=$_POST['cl_state'];

if ($adults=1){$working=0;}
