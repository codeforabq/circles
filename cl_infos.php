...
function ShowThatsAllFolks()
  ...
  <body>
  <?php
  if (!isset($ishomeless)){$ishomeless="No";}
    //echo "<table border=\"1\">";
...
<form id="cl_infos_form" enctype="multipart/form-data" method="POST" action="cl_infos.php" novalidate="novalidate" style="padding: 10px;" autocomplete="off">
	<!-- START HEADER -->
...
<?php
      if (isset($_POST['cl_stateinits'])){$cl_stateinits=$_POST['cl_stateinits'];}
      if (isset($_POST['cl_state']))
        {
          ...
          else {echo "<option value=\"\">Choose one</option><option value=\"\"></option>";}
  ...
  ?>
          ...
          <?php if (isset($cl_stateinits)){echo "<input type=\"hidden\" name=\"cl_stateinits\" value=\"".$cl_stateinits."\">";} ?>
          </div><!-- END STATES -->
<?php
          if (isset($cl_state))
          {
          echo "<div id=\"cl_counties\" name=\"County\" style=\"opacity: 1; float:left; width: 33%;\"><label class=\"form-els\">County</label><br>
            ...
            else {echo "<option value=\"\">Choose one</option>";}
...
echo "<form id=\"cl_infos_form\" enctype=\"multipart/form-data\" method=\"POST\" action=\"cl_expenses.php\" novalidate=\"novalidate\" style=\"padding: 10px;\" autocomplete=\"off\">";
  ...
  if (isset($cl_stateinits)){echo "<input type=\"hidden\" name=\"cl_stateinits\" value=\"".$cl_stateinits."\">";}
    ...
    <div id=\"cl_beds\" name=\"Beds\" style=\"opacity: 1; float:left; width: 100%;\">
     ...
     <div id="cl_utilsmortrent" name="Utilities+Rent/Mort" style="opacity: 1; float:left; width: 100%;">
          ...
          <input type="radio" id="cl_utilbutt1" name="cl_utilities" value="sua2" onchange="ShowAboutFamily();"/><span class="button-text">Heating/Cooling expenses</span><br>
          <input type="radio" id="cl_utilbutt2" name="cl_utilities" value="sua3" onchange="ShowAboutFamily();" /><span class="button-text">Only (2) utilities (Not Heating/Cooling)</span><br>
          <input type="radio" id="cl_utilbutt3" name="cl_utilities" value="sua4" onchange="ShowAboutFamily();" /><span class="button-text">Only (1) utility (not Phone, Heating/Cooling)</span><br>
          <input type="radio" id="cl_utilbutt4" name="cl_utilities" value="sua5" onchange="ShowAboutFamily();" /><span class="button-text">Only phone bill (some states allow mobile/cell phones)</span><br>
          <input type="radio" id="cl_utilbutt5" name="cl_utilities" value="sua6" onchange="ShowAboutFamily();" /><span class="button-text">No utilities paid</span><br><br>
        </div>
	...
	<div id="AboutFamilyLabel" style="opacity: 1; float:left; width: 100%;">
      ...
      <div id="ArePeople21" class="h2" style="opacity: 1; float:left; width:100%;">
        ...
        <div id="HowMany21s" style="opacity: 1; float:left; width:100%;">
          ...
          <input type="text" id="cl_adults" name="cl_adults" placeholder="Type number here" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowDoAnyPT();" >Next</button><br><br>
        </div>

      <div id="DoAnyPT" class="h3" style="opacity: 1; float:right; width:90%; font-size=14;">
          <p>
            Do any of them work Part-Time?
			<input type="radio" id="21orOlderPTYes" name="twentyone_or_older_PTcheck" value="Yes" onchange="ShowHowManyPT();"/><span style="font-size: 12px; color: black;">Yes</span>
			<input type="radio" id="21orOlderPTNo" name="twentyone_or_older_PTcheck" value="No" onchange="ShowDoAnyPTNo();"/><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>
        ...
        <div id="HowManyPT" style="opacity: 1; float:right; width:90%;">
          ...
          <input type="text" id="cl_adults_PT" maxlength="25" placeholder="Type number here" name="cl_adults_PT" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowDoAnyFT();" >Next</button><br><br>
        </div>

      <div id="DoAnyFT" class="h3" style="opacity: 1; float:right; width:90%; font-size=14;">
          <p>
            Do any of them work Full-Time?
			<label id="item58_0_label"><input type="radio" id="21orOlderFTYes" name="twentyone_or_older_FTcheck" value="Yes" onchange="ShowHowManyFT();"/><span style="font-size: 12px; color: black;">Yes</span></label>
			<label id="item58_1_label"><input type="radio" id="21orOlderFTNo" name="twentyone_or_older_FTcheck" value="No" onchange="ShowDoAnyFTNo();"/><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>
        ...
        <div id="HowManyFT" style="opacity: 1; float:right; width:90%;">
          ...
          <input type="text" id="cl_adults_FT" maxlength="25" placeholder="Type number here"  onkeyup="this.value=this.value.replace(/[^\d]/,'')" name="cl_adults_FT" /><button type="button" class="nextbutton" onclick="ShowMonthlyWorkExpenses();">Next</button><br><br>
        </div>
      ...
      <div id="WorkExpensesReimbursed" class="h3" style="opacity: 1; float:right; width:90%;">
          <p>
			...
			<input type="radio" id="WorkExpensesYes" name="twentyone_or_older_Expcheck" value="Yes" onclick="ShowMonthlyWorkExpensesYes();"/><span style="font-size: 12px; color: black;">Yes</span>
			<input type="radio" id="WorkExpensesNo" name="twentyone_or_older_Expcheck" value="No" onclick="ShowMonthlyWorkExpensesNo();"/><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>
        ...
        <div id="HowMuchWorkExpense" style="opacity: 1; float:right; width:90%;">
          ...
          &nbsp;&nbsp;&nbsp;$&nbsp;<input type="text" id="WorkExpenseAmount" name="WorkExpenseAmount" maxlength="25" placeholder="Type amount here" name="cl_adults_workexpense" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button  type="button" class="nextbutton" onclick="ShowGetPeople13to20();">Next</button><br><br>
        </div>

     <div id="ArePeople13to20" class="h2" style="opacity: 1; float: left; width: 100%">
          <p style="font-weight: bold; color: rgb(242, 117, 34);">
            Are there people 13 to 20 years old in the home?
        	<input type="radio" id="item59_0_radio" name="thirteen_to_twenty_check" value="Yes" onchange="ShowHowMany13to20();"/><span style="font-size: 12px; color: black;">Yes</span></label>
          <label id="item59_1_label"><input type="radio" id="item59_1_radio" name="thirteen_to_twenty_check" value="No" onchange="ShowHowMany13to20No();"/><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>

      <div id="HowMany13to20" style="opacity: 1; float:left; width:100%;">
          <label id="item102_label_0" style="display: inline; font-weight: bold;" class="button-text">How many?</label>
          <input type="text" id="13to20Count" maxlength="25" placeholder="Type number here" name="cl_thirteen_to_twenty" onkeyup="this.value=this.value.replace(/[^\d]/,'')" /><button type="button" class="nextbutton" onclick="ShowAreAny19to20();">Next</button><br><br>
      </div>

      <div id="AreAny19to20" class="h3" style="opacity: 1; float:right; width:90%;">
          <p>
            Are any of them 19 to 20 years old?
			<label id="item58_0_label"><input type="radio" id="19to20Yes" name="19to20_check" value="Yes" onchange="ShowHowMany19to20();"/><span style="font-size: 12px; color: black;">Yes</span></label>
			<label id="item58_1_label"><input type="radio" id="19to20No" name="19to20_check" value="No"  onchange="ShowHowMany19to20No();"/><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>

        <div id="HowMany19to20" style="opacity: 1; float:right; width:90%;">
          <label id="item99_label_0" style="display: inline; font-size: 13px;" " class="button-text">How many?</label>
		  <input type="text" id="19to20Count" maxlength="25" placeholder="Type number here" name="cl_19to20" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowAreAny13to18();">Next</button><br><br>
        </div>

      <div id="AreAny13to18" class="h3" style="opacity: 1; float:right; width:90%;">
          <p>
            Are any of them 13 to 18 years old?
			<input type="radio" id="13to18Yes" name="13to18_check" value="Yes" onchange="ShowHowMany13to18();"/><span style="font-size: 12px; color: black;">Yes</span>
			<input type="radio" id="13to18No" name="13to18_check" value="No" onchange="ShowHowMany13to18No();"/><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>

        <div id="HowMany13to18" style="opacity: 1; float:right; width:90%;">
          <label style="display: inline; font-size: 13px;" " class="button-text">How many?</label>
		  <input id="13to18Count" type="text" maxlength="25" placeholder="Type number here" name="cl_13to18" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowAreAnyUnable();">Next</button><br><br>
        </div>

      <div id="AreAnyUnable" class="h3" style="opacity: 1; float:right; width:90%;">
          <p>
            Are any of them UNABLE to care for themselves?
			<input type="radio" id="AnyUnableYes" name="unable_check" value="Yes" onchange="ShowHowManyUnable();" /><span style="font-size: 12px; color: black;">Yes</span>
			<input type="radio" id="AnyUnableNo" name="unable_check" value="No" onchange="ShowHowManyUnableNo();" /><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>

        <div id="HowManyUnable" style="opacity: 1; float:right; width:90%;">
          <label style="display: inline; font-size: 13px;" " class="button-text">How many?</label>
		  <input id="AnyUnableCount" type="text" maxlength="25" placeholder="Type number here" name="cl_unable" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowAreAnyLessThan13();">Next</button><br><br>
        </div>
    ...
    <div id="ArePeopleLessThan13" class="h2" style="opacity: 1; float: left; width: 100%">
          ...
          <input type="radio" id="PeopleLessThan13Yes" name="less_than_thirteen_check" value="Yes" onchange="ShowHowManyLessThan13();" /><span style="font-size: 12px; color: black;">Yes</span>
          <input type="radio" id="PeopleLessThan13No" name="less_than_thirteen_check" value="No" onchange="ShowAreAnyLessThan13No();" /><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>

      <div id="HowManyLessThan13" style="opacity: 1; float:left; width:100%;">
          <label id="item102_label_0" style="display: inline; font-weight: bold;" class="button-text">How many?</label>
          <input type="text" id="LessThan13Count" maxlength="25" placeholder="Type number here" name="cl_less_than_thirteen" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" onclick="ShowChildInfos();" class="nextbutton">Next</button>
      </div>

    <div id="GetChild1" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 1:&nbsp;&nbsp;</label>

      <div id="Child1Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          ...
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child1_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          ...
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child1_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
    ...
    <div id="GetChild2" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 2:&nbsp;&nbsp;</label>

      <div id="Child2Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child2Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child2_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
          <div id="Child2Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child2_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
    ...
    <div id="GetChild3" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 3:&nbsp;&nbsp;</label>

      <div id="Child3Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child3Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child3_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child3Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child3_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
    ...
    <div id="GetChild4" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 4:&nbsp;&nbsp;</label>

      <div id="Child4Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child4Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child4_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child4Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child4_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
    ...
    <div id="GetChild5" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 5:&nbsp;&nbsp;</label>

      <div id="Child5Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child5Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child5_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child5Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child5_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild6" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 6:&nbsp;&nbsp;</label>

      <div id="Child6Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child6Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child6_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child6Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child6_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild7" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 7:&nbsp;&nbsp;</label>

      <div id="Child7Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child7Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child7_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child7Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child7_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild8" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 8:&nbsp;&nbsp;</label>

      <div id="Child8Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child8Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child8_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child8Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child8_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild9" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 9:&nbsp;&nbsp;</label>

      <div id="Child9Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child9Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child9_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child9Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child9_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild10" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 10:&nbsp;&nbsp;</label>

      <div id="Child10Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child10Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child10_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child10Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child10_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild11" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 11:&nbsp;&nbsp;</label>

      <div id="Child11Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child11Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child11_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child11Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child11_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')" />
          </div>
    ...
    <div id="GetChild12" style="opacity: 1; float:left; width: 100%; text-align: right; padding-bottom: 10px; padding-top: 20px;">
          <label class="h2">Child 12:&nbsp;&nbsp;</label>

      <div id="Child12Infos" style="opacity: 1; float:right; width:85%; border: 1px solid; padding-left: 10px; padding-bottom: 10px; text-align: left;">
          <div id="Child12Years"  style="float: left; width:10%;">
          <label id="item107_label_0" style="display: inline;" class="button-text">Years</label><br>
          <input type="text" id="item107_text_1" maxlength="5" size="5" placeholder="0" name="cl_child12_years" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
          <div id="Child12Months" style="float: left; width:15%;">
          <label id="item108_label_0" style="display: inline;" class="button-text">Months</label><br>
          <input type="text" id="item108_text_1" maxlength="5" size="5" placeholder="0" name="cl_child12_months" class="button-text" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/>
          </div>
	...
	<div id="LastChild" style="float: right; width:85%;"><button type="button" onclick="ShowDayCareInfos();" class="nextbutton">Next</div><br><br>

      <div id="DayCareInfos" style="opacity: 1; padding-bottom: 0px; padding-top: 14px; float: left; width: 100%; color: black;">
          <p class="form-els">
      ...
      <div id="DayCareDays" style="opacity: 1; float: right; width: 85%;">
          <label id="item68_label_0" style="display: inline; font-weight: normal;" class="button-text">How many days of the week is child care needed?</label>
          		  <input id="DayCareDaysIn" type="text" maxlength="25" placeholder="Type number here" name="cl_child_care_days" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" onclick="ShowDayCareHours();" class="nextbutton">Next</button><br><br>
      </div><!-- END OF DAY CARE DAYS -->

      <div id="DayCareHours" style="opacity: 1; float: right; width: 85%;">
          <label id="item69_label_0" style="display: inline; font-weight: normal;" class="button-text">How many hours per day is child care needed?</label>
          		  <input id="DayCareHoursIn" type="text" maxlength="25" placeholder="Type number here" name="cl_child_care_hours" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" onclick="ShowDayCarePlace();" class="nextbutton">Next</button><br><br>
      </div><!-- END OF DAY CARE HOURS -->

      <div id="DayCarePlace" style="opacity: 1; float: right; width: 85%">
          <label id="item76_label_0" style="display: inline;" class="button-text">Where is child care provided?</label><br>
			<input type="radio" id="item76_0_radio" data-hint="" name="cl_child_care_location" value="In unlicensed home" onchange="ShowDayCareFaith();" /><span class="button-text">In unlicensed home</span><br>
          	<input type="radio" id="item76_1_radio" name="cl_child_care_location" value="In licensed home/group home" onchange="ShowDayCareFaith();" /><span class="button-text">In licensed home/group home</span><br>
          	<input type="radio" id="item76_2_radio" name="cl_child_care_location" value="By licensed center" onchange="ShowDayCareFaith();" /><span class="button-text">By licensed center</span><br>
          	<input type="radio" id="item76_3_radio" name="cl_child_care_location" value="In unlicensed exempt center/program" onchange="ShowDayCareFaith();" /><span class="button-text">In unlicensed exempt center/program</span><br>
          	<input type="radio" id="item76_4_radio" name="cl_child_care_location" value="In child&rsquo;s own home" onchange="ShowDayCareFaith();" /><span class="button-text">In child&rsquo;s own home</span><br><br>
        </div>

      <div id="DayCareFaith" style="opacity: 1; float: right; width: 85%">
          <label id="item78_label_0" style="display: inline;" class="button-text">Is child care provider Faith Based?</label>
          <input type="radio" id="item78_0_radio" data-hint="" name="cl_child_care_faithbased" value="Yes" onchange="ShowAddFamily();"/><span class="button-text" style="font-size: 12px; color: black;" >Yes</span>
          <input type="radio" id="item78_1_radio" name="cl_child_care_faithbased" value="No" onchange="ShowAddFamily();"/><span class="button-text" style="font-size: 12px; color: black;">No</span>
      <br><br></div>
   ...
   <div id="FTCollegeStudents" class="h2" style="opacity: 1; float: left; width: 100%">
          ...
          <input type="radio" id="item59_0_radio" name="FTCollegeStudents_check" value="Yes" onchange="ShowHowManyFTCollege();" /><span style="font-size: 12px; color: black;">Yes</span>
          <input type="radio" id="item59_1_radio" name="FTCollegeStudents_check" value="No"  onchange="ShowCurrentPreg();" /><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>

      <div id="HowManyFTCollegeStudents" style="opacity: 1; float:left; width:100%;">
          <label id="item102_label_0" style="display: inline; font-weight: bold;" class="button-text">How many?</label>
          <input type="text" id="FTCollegeCount" maxlength="25" placeholder="Type number here" name="cl_family_college_students" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowCurrentPreg();" >Next</button>
      </div>

   <div id="CurrentPreg" class="h2" style="opacity: 1; float: left; width: 100%">
          <p style="font-weight: bold; color: rgb(242, 117, 34);">
           Is there a current pregnancy?
          <input type="radio" id="item59_0_radio" name="cl_family_pregnancy_check" value="Yes" onchange="ShowStepParent();"/><span style="font-size: 12px; color: black;">Yes</span>
          <input type="radio" id="item59_1_radio" name="cl_family_pregnancy_check" value="No" onchange="ShowStepParent();"/><span style="font-size: 12px; color: black;">No</span>
          </p>
      </div>
   ...
   <div id="StepParent" class="h2" style="opacity: 1; float: left; width: 100%">
          ...
          <label id="item59_0_label"><input type="radio" id="item59_0_radio" name="cl_family_stepparent_check" value="Yes" onchange="ShowAllReceiving();" /><span style="font-size: 12px; color: black;">Yes</span></label>
          <label id="item59_1_label"><input type="radio" id="item59_1_radio" name="cl_family_stepparent_check" value="No" onchange="ShowAllReceiving();" /><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>

   <div id="AllReceiving" class="h2" style="opacity: 1; float: left; width: 100%">
          <p style="font-weight: bold; color: rgb(242, 117, 34);">Are ALL members in this home receiving TANF, GA or SSI?
          <label id="item59_0_label"><input type="radio" id="item59_0_radio" name="cl_family_All_onBenefits_check" value="Yes" onchange="ShowAdults60Plus();" /><span style="font-size: 12px; color: black;">Yes</span></label>
          <label id="item59_1_label"><input type="radio" id="item59_1_radio" name="cl_family_All_onBenefits_check" value="No" onchange="ShowAdults60Plus();" /><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>
   ...
   <div id="Adults60PlusYN" class="h2" style="opacity: 1; float: left; width: 100%">
          ...
          <label id="item59_0_label"><input type="radio" id="item59_0_radio" name="cl_family_over60_check" value="Yes" onchange="ShowHowMany60PlusYes();" /><span style="font-size: 12px; color: black;">Yes</span></label>
          <label id="item59_1_label"><input type="radio" id="item59_1_radio" name="cl_family_over60_check" value="No" onchange="ShowThatsAllFolks();" /><span style="font-size: 12px; color: black;">No</span></label>
          </p>
      </div>

      <div id="HowMany60Plus" style="opacity: 1; float:left; width:100%;">
          <label id="item102_label_0" style="display: inline; font-weight: bold;" class="button-text">How many?</label>
          <input type="text" id="60PlusCount" maxlength="25" placeholder="Type number here" name="cl_family_over60_count" onkeyup="this.value=this.value.replace(/[^\d]/,'')"/><button type="button" class="nextbutton" onclick="ShowThatsAllFolks();" >Next</button><br><br>
      </div>
     <div id="ThatsAllFolks" style="opacity: 1; float:left; width:100%; text-align: center;">
         <button type="submit" class="nextbutton" onclick="" >Next (Monthly Expenses) --></button><br><br>
      </div>
