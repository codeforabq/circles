...
(function(root, factory) {
	...
	(function(H) {
		...
		H.seriesType = function(type, parent, options, props, pointProps) { // docs: add to API + extending Highcharts
			...
			// Create the class
			seriesTypes[type] = H.extendClass(seriesTypes[parent] || function() {
				}, props);
	...
	(function(H) {
		...
		H.Pointer.prototype = {
			...
			onTrackerMouseOut: function(e) {
				...
				if(series && relatedTarget && !series.options.stickyTracking && !this.inClass(relatedTarget, 'highcharts-tooltip') && !this.inClass(relatedTarget, 'highcharts-series-' + series.index)) { // #2499, #4465
					series.onMouseOut();
				}
			},
