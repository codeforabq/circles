...
(function(f) {
	function h(b) {
		...
		for(e = 0; e < g.length; e++) {
			var f = g[e].process, k = g[e].re.exec(b);
		...
		this.getHelpXML = function() {
			for(var a = [], c = 0; c < g.length; c++)for(var d = g[c].example, b = 0; b < d.length; b++)a[a.length] = d[b];
			for(var e in m)a[a.length] = e;
			d = document.createElement("ul");
			d.setAttribute("id", "rgbcolor-examples");
			for(c = 0; c < a.length; c++)try {
				var f = document.createElement("li"), l = new h(a[c]), n = document.createElement("div");
