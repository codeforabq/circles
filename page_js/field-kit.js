...
// v8 likes predictible objects
			...
			(function(global, factory) {
				...
				function round(strnum, precision, mode) {
					...
					switch(mode) {
						...
						case modes.HALF_EVEN:
						case modes.HALF_DOWN:
						case modes.HALF_UP:
		...
		}, {"./amex_card_formatter": 5, "./card_utils": 7, "./default_card_formatter": 9}],
		...
		}, {"./adaptive_card_formatter": 4, "./card_utils": 7, "./text_field": 20}],
		...
		}, {"./card_utils": 7, "./delimited_text_formatter": 10}],
		...
		}, {"./expiry_date_formatter": 13, "./text_field": 20}],
		...
		}, {"./delimited_text_formatter": 10, "./utils": 22}],
		...
		15: [function(_dereq_, module, exports) {
			...
			"./adaptive_card_formatter": 4,
			"./amex_card_formatter": 5,
			"./card_text_field": 6,
			"./card_utils": 7,
			"./default_card_formatter": 9,
			"./delimited_text_formatter": 10,
			"./employer_identification_number_formatter": 11,
			"./expiry_date_field": 12,
			"./expiry_date_formatter": 13,
			"./formatter": 14,
			"./number_formatter": 16,
			"./number_formatter_settings_formatter": 17,
			"./phone_formatter": 18,
			"./social_security_number_formatter": 19,
			"./text_field": 20,
			"./undo_manager": 21
		}],
...
// Style
		...
		}, {"./formatter": 14, "./number_formatter_settings_formatter": 17, "./utils": 22, "stround": 3}],
			...
			var TextField = (function(_Input) {
				...
				_createClass(TextField, [{
					...
					value: function _processChange(_ref) {
						...
						var onFail = _ref$onFail === undefined ? function() {
							} : _ref$onFail;
		...
		}, {"./caret": 8, "./formatter": 14, "./undo_manager": 21, "./utils": 22, "input-sim": 2}],
