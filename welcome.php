...
Our new web based version of this tool makes it possible to run the analysis from anywhere with internet access.<br><br>
</div>

  <div style="float: left; width=100%; padding-left: 44%;">
  <button type="reset" onclick="location.href='disclaimer.php'" style="border: none; color: white; padding: 7px 10px; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; font-weight: bold; background-color: rgb(0, 163, 222); font-family: Helvetica, Arial; background-image: none;">Continue -></button>
  </div>
